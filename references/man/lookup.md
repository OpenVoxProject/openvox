...
canonical: "/openvox/latest/man/lookup.html"
---
...
## DESCRIPTION
The lookup command is a CLI for OpenVox\'s \'lookup()\' function. It
...
command will use the requested node\'s real stored facts from OpenVoxDB;
if OpenVoxDB isn\'t configured or you want to provide arbitrary fact
...
- \--node *NODE-NAME* Specify which node to look up data for; defaults
  ...
  configured to talk to OpenVoxDB, the command will use the requested
...
- \--environment *ENV* Like with most OpenVox commands, you can specify
...
To look up \'key_name\' using the OpenVox Server node\'s arbitrary
