...
**download** - Download this node\'s catalog from the OpenVox server.
...
:   **SYNOPSIS**
    ...
    **DESCRIPTION**
    ...
    Retrieves a catalog from the OpenVox server and saves it to the
    local yaml cache. This action always contacts the OpenVox server and
    will ignore alternate termini.
...
:   **SYNOPSIS**
    ...
    **NOTES**
    ...
    By default, this action will retrieve a catalog from OpenVox\'s
    compiler subsystem; you must call the action with **\--terminus
    rest** if you wish to retrieve a catalog from the OpenVox server.
