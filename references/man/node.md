...
## ACTIONS
**clean** - Clean up signed certs, cached facts, node objects, and reports for a node stored by the OpenVox server
...
:   **SYNOPSIS**
    ...
    **DESCRIPTION**
    ...
    Cleans up the following information an OpenVox server knows about a
    node:
    ...
    *Reports* - (\$vardir/reports/node.domain)
    ...
    NOTE: this action now cleans up certs via OpenVox Server\'s CA API.
    A running server is required for certs to be cleaned.
