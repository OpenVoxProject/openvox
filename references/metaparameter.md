...
toc: columns
canonical: "/openvox/latest/metaparameter.html"
---
...
Creates an alias for the resource.  OpenVox uses this internally when you
...
A schedule to govern when OpenVox is allowed to manage this resource.
