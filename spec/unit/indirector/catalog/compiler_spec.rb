...
describe Puppet::Resource::Catalog::Compiler do
  ...
  describe "when finding catalogs" do
    ...
    it "errors if checksum_type contains no shared checksum types" do
      ...
      expect { compiler.find(@request) }.to raise_error Puppet::Error,
        "Unable to find a common checksum type between agent 'atime.md2' and server '[:sha256, :sha256lite, :md5, :md5lite, :sha1, :sha1lite, :sha512, :sha384, :sha224, :mtime, :ctime, :none, :etag]'."
    end
    ...
    it "errors if checksum_type contains no shared checksum types" do
      ...
      expect { compiler.find(@request) }.to raise_error Puppet::Error,
        "Unable to find a common checksum type between agent '' and server '[:sha256, :sha256lite, :md5, :md5lite, :sha1, :sha1lite, :sha512, :sha384, :sha224, :mtime, :ctime, :none, :etag]'."
    end
