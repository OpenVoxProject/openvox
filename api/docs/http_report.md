...
[documentation](https://docs.openvoxproject.org/openvox/latest/format_report.html).
...
The content of a report is typically generated by the OpenVox Runtime and consists of a JSON serialization of `Puppet::Transaction::Report` object which in turn contains a structure of objects with of the following runtime types:
