  ...
  def help
    <<~HELP
      ...
      * --certname:
        ...
        (This is a OpenVox setting, and can go in puppet.conf.)

      * --daemonize:
        Send the process into the background. This is the default.
        (This is a OpenVox setting, and can go in puppet.conf. Note the special 'no-'
      ...
      *  --evaltrace:
        ...
        see exactly what is being done. (This is a OpenVox setting, and can go in
      ...
      * --trace
        Prints stack traces on some errors. (This is a OpenVox setting, and can go in
        puppet.conf. Note the special 'no-' prefix for boolean settings on the command line.)
