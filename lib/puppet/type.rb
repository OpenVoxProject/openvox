...
class Type
  ...
  newmetaparam(:noop) do
    desc "Whether to apply this resource in noop mode.
      ...
      When applying a resource in noop mode, OpenVox will check whether it is in sync,
      ...
      **Important note:**
      [The `noop` setting](https://docs.openvoxproject.org/openvox/latest/configuration.html#noop)
  ...
  newmetaparam(:schedule) do
    desc "A schedule to govern when OpenVox is allowed to manage this resource.
      ...
      [the docs for the `schedule` type](https://docs.openvoxproject.org/openvox/latest/type.html#schedule)
      for more info.
  ...
  newmetaparam(:audit) do
    desc "Marks a subset of this resource's unmanaged attributes for auditing. Accepts an
      ...
      is applied with puppet apply or puppet agent, OpenVox will check whether
      ...
      performed by OpenVox while applying the catalog.
      ...
      changes made by OpenVox will be logged as additional modifications. (I.e.
      ...
      and the second run will log the edit made by OpenVox.)"
  ...
  newmetaparam(:alias) do
    desc "Creates an alias for the resource.  OpenVox uses this internally when you
      ...
      There's no way here for the OpenVox parser to know that these two stanzas
  ...
  newmetaparam(:tag) do
    desc "Add the specified tags to the associated resource.  While all resources
      ...
      with [the `tags` setting](https://docs.openvoxproject.org/openvox/latest/configuration.html#tags)
  ...
  newmetaparam(:require, :parent => RelationshipMetaparam, :attributes => { :direction => :in, :events => :NONE }) do
    desc "One or more resources that this resource depends on, expressed as
      ...
      * The required resources will be applied **before** this resource.
      ...
      [the language page on relationships](https://docs.openvoxproject.org/openvox/latest/lang_relationships.html)."
  end
  ...
  newmetaparam(:subscribe, :parent => RelationshipMetaparam, :attributes => { :direction => :in, :events => :ALL_EVENTS, :callback => :refresh }) do
    desc "One or more resources that this resource depends on, expressed as
      ...
      * If OpenVox makes changes to any of the subscribed resources, it will cause
  ...
  newmetaparam(:notify, :parent => RelationshipMetaparam, :attributes => { :direction => :out, :events => :ALL_EVENTS, :callback => :refresh }) do
    desc "One or more resources that depend on this resource, expressed as
      ...
      * If OpenVox makes changes to this resource, it will cause all of the
  ...
  newmetaparam(:stage) do
    desc %{Which run stage this class should reside in.
      ...
      * Declare the new stage as a [`stage` resource](https://docs.openvoxproject.org/openvox/latest/type.html#stage).
  ...
  #   attribute value pairs.  Generally, OpenVox calls any of these things an
